...
func (s *server) handlerShortenLink(w http.ResponseWriter, r *http.Request) {
	...
	s.logger.Info("Shortening URL:", longURL, slog.String("user", user))
	...
	s.logger.Info("Generated short code", slog.String("shortCode", shortCode), slog.String("longURL", longURL))
